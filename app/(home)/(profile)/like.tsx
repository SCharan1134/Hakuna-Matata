...
import { useLikedPlacesStore } from "@/store/useLikedPlacesStore";
...
export default function Like() {
  ...
  const setPlaces = useLikedPlacesStore((state) => state.setPlaces);
  const getSavedPlaces = async () => {
    try {
      ...
      const savedPlaceuuids = profile?.like_place || [];
  ...
  const SavedPlaces = useLikedPlacesStore((state) => state.places);
